...
import { LoreEntity, EntityType } from '../types';
...
const WorldBiblePage: React.FC<WorldBiblePageProps> = ({ data, onSelect, lang }) => {
  const [filter, setFilter] = useState<string>('All');
  const t = DICTIONARY[lang];

  const categories = ['All', 'Character', 'Location', 'Timeline', 'Artifact'];
